...
acraengdemo_launch_project_drupal-transparent() {
    ...
    COSSACKLABS_DRUPAL_VCS_URL='https://github.com/django/djangoproject.com'
    COSSACKLABS_DRUPAL_VCS_BRANCH=${COSSACKLABS_DRUPAL_VCS_BRANCH:-master}
    COSSACKLABS_DRUPAL_VCS_REF='60753aa0013f67eb4aa42a1aca1451d0ac9dab81'

    COMPOSE_ENV_VARS="COSSACKLABS_ACRAENGDEMO_VCS_URL=\"$COSSACKLABS_ACRAENGDEMO_VCS_URL\" "\
"COSSACKLABS_ACRAENGDEMO_VCS_BRANCH=\"$COSSACKLABS_ACRAENGDEMO_VCS_BRANCH\" "\
"COSSACKLABS_ACRAENGDEMO_VCS_REF=\"$COSSACKLABS_ACRAENGDEMO_VCS_REF\" "\
"COSSACKLABS_DRUPAL_VCS_URL=\"$COSSACKLABS_DRUPAL_VCS_URL\" "\
"COSSACKLABS_DRUPAL_VCS_BRANCH=\"$COSSACKLABS_DRUPAL_VCS_BRANCH\" "\
"COSSACKLABS_DRUPAL_VCS_REF=\"$COSSACKLABS_DRUPAL_VCS_REF\" "\
"COSSACKLABS_ACRAENGDEMO_BUILD_DATE=\"$(date -u +'%Y-%m-%dT%H:%M:%SZ')\""
